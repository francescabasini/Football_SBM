...
<img src="ReadMe_pics/Final_table.jpg" width="60%" />

* ```Heatmap_Season_*season*.pdf``` the match grid of the season with results categorised by colour.

<img src="ReadMe_pics/Heatmap_Season_1819.png" width="60%" />

* ```Heatmap_Estimated_Season_*season*.pdf``` the permuted match grid of the season, from *a posteriori* analysis, with teams listed according to the most likely block membership, results categorised by colour. This file is saved only when the MAP for K is larger than 1.

<img src="ReadMe_pics/Heatmap_Estimated_Season_1819.png" width="60%" />
...
<img src="ReadMe_pics/Ktrue_NF_Premier_Season_1819_200k_seed1909.png" width="60%" />
...
<img src="ReadMe_pics/Summary_tables.jpg" width="60%"/>
